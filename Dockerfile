...
RUN export DEBIAN_FRONTEND=noninteractive; apt-get -y update && \ 
 ...
 apt-get -y update && \ 
 R -e "install.packages(c( 'stats', 'utils', 'h2o', 'xgboost', 'elmNNRcpp', 'RWeka', 'gbm', 'kknn', 'MASS', 'nnet', 'e1071', 'LiblineaR', 'extraTrees', 'glmnet', 'randomForest', 'kernlab', 'caret', 'adabag', 'testthat', 'covr', 'remotes' ), repos =  'https://cloud.r-project.org/' )" && \ 
